...
/*
  O nome da loja vem do config, NÃO do <title>. A versão anterior fazia
  `document.title.split('|')[0]`, o que quebrou assim que o título passou a
  usar travessão: o cabeçalho do pedido saía "Loja — tagline".
*/
