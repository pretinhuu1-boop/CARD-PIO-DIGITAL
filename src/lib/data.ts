...
/* CATEGORIAS                                                                  */
/* -------------------------------------------------------------------------- */
/* Ordem das seções na página. Vem de `category_label` de cada produto, não  */
/* do parâmetro de categoria da API — que a plataforma ignora.               */
...
/* PRODUTOS                                                                    */
/* -------------------------------------------------------------------------- */
/* 10 itens, escolhidos por terem preço E foto distinta: a plataforma        */
/* reaproveita imagem entre produtos, e 20 dos 100 itens não têm foto.       */
