 ...
 *
 * Duas guardas impedem que a supressão engula clique legítimo:
 *
 * 1. Só suprime se a faixa REALMENTE rola (`scrollWidth > clientWidth`).
 *    Com poucas categorias os chips cabem na tela e não há o que arrastar —
 *    qualquer movimento ali é tremor de mão, não intenção de rolar.
 * 2. Limiar de 10px, não 4px. A mão de quem clica se move de 4 a 8px entre o
 *    apertar e o soltar; com o limiar antigo, TODO clique de mouse virava
 *    "arrasto" e o filtro não trocava nunca.
 */
